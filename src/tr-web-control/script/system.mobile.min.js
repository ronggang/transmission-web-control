...
break
case"verify":if(1==r.length){if(transmission.torrents.all[r[0]].percentDone>0&&0==confirm(system.lang.toolbar.tip["recheck-confirm"]))return}else if(0==confirm(system.lang.toolbar.tip["recheck-confirm"]))return}e=$(e),e.attr("disabled",!0),transmission.exec({method:"torrent-"+t,arguments:arguments},function(t){e.attr("disabled",!1),system.reloadTorrentBaseInfos()}),this.torrentListChecked=!1}},addTorrentsToServer:function(t,e,s,n,r){var a=e-t.length,o=t.shift()
if(!o)return this.showStatus(this.lang.system.status.queuefinish),this.getServerStatus(),void(r&&r())
this.showStatus(this.lang.system.status.queue,e-a+1),transmission.addTorrentFromUrl(o,n,s,function(a){system.addTorrentsToServer(t,e,s,n,r)})},showStatus:function(t,e){if(!t)return void $("#status").hide()
$("#status").show(),$("#status-msg").html(t),$.isNumeric(e)?$("#status-count").html(e).show():$("#status-count").hide()}}
