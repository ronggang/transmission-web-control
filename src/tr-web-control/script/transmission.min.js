...
o.onload=function(t){var o=t.target.result,a=o.indexOf("base64,")
if(-1!=a){var i=o.substring(a+"base64,".length)
transmission.exec({method:"torrent-add",arguments:{metainfo:i,"download-dir":e,paused:s}},function(t){switch(t.result){case"success":n&&n(t.arguments["torrent-added"],r)
break
...
if(!r)return!1
this.exec({method:"torrent-rename-path",arguments:{ids:[t],path:e||r.name,name:s}},function(t){n&&n(t)})},closeSession:function(t){this.exec({method:"session-close"},function(e){t&&t(e)})}}
