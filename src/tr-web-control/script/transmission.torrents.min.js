...
if(!s)return
if(-1!=$.inArray(s.id,r)&&r.length>0)this.all[s.id]&&(this.all[s.id]=null,delete this.all[s.id]),this.datas[n]=null,delete this.datas[n]
...
break
case e.download:this.downloading.push(s)}if(this.all[s.id]=s,-1==$.inArray(s.downloadDir,transmission.downloadDirs)&&transmission.downloadDirs.push(s.downloadDir),transmission.options.getFolders&&s.downloadDir){var a=s.downloadDir.split("/"),o="folders-"
...
if(e.leecherCount=0,e.seederCount=0,t.length>0){for(var s in t){var r=t[s],i=r.lastAnnounceResult.toLowerCase(),a=r.host.replace("http://","").replace("https://","").split(":")[0].split(".");-1!=$.inArray(a[0],"www,tracker".split(","))&&a.shift()
...
t||(t=this.all)
var n=new Array
return $.each(t,function(s,r){-1!=t[s].name.toLowerCase().indexOf(e.toLowerCase())&&n.push(t[s])}),this.searchResult=n,n},getFiles:function(e,t){transmission.exec({method:"torrent-get",arguments:{fields:"files,fileStats".split(","),ids:e}},function(e){"success"==e.result?t&&t(e.arguments.torrents):t&&t(null)})},getConfig:function(e,t){this.getMoreInfos(this.fields.config,e,t)},getErrorIds:function(e,t){var n=new Array,s=new Date
1==t&&(s=s.getTime()/1e3)
for(var r in this.error){var i=this.error[r];-1!=$.inArray(i.id,e)&&e.length>0||(1==t&&s<i.nextAnnounceTime||i.status!=transmission._status.stopped&&n.push(i.id))}for(var r in this.warning){var i=this.warning[r];-1!=$.inArray(i.id,e)&&e.length>0||(1==t&&s<i.nextAnnounceTime||n.push(i.id))}return n},searchAndReplaceTrackers:function(e,t,n){if(e&&t){var s={},r=0
for(var i in this.all){var a=this.all[i]
if(!a)return
var o=a.trackerStats
for(var l in o){o[l].announce==e&&(s[l]||(s[l]={ids:new Array,tracker:t}),s[l].ids.push(a.id),r++)}}0==r&&n&&n(null,0)
