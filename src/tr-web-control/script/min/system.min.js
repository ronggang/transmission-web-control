...
"-"+a.split("-")[1].toLocaleUpperCase());this.languages[a]||(a="en");$.getScript(system.rootPath+"lang/"+a+".js",function(){system.lang=$.extend(!0,system.defaultLang,system.lang);system.resetLangText();$.getScript(system.rootPath+"script/easyui/locale/easyui-lang-"+a.replace("-","_")+".js").done(function(a,d){b&&b()}).fail(function(a,d,e){$.getScript(system.rootPath+"script/easyui/locale/easyui-lang-en.js",function(){b&&b()})})})},init:function(a,b,c){this.readConfig();this.islocal=1==b?!0:!1;this.panel=
...
resetLangText:function(a){a||(a=$);var b=a.find("*[system-lang]");$.each(b,function(a,b){a=$(b).attr("system-lang");"["==a.substr(0,1)?$(b).html(eval("system.lang"+a)):$(b).html(eval("system.lang."+a))});b=a.find("*[system-tip-lang]");$.each(b,function(a,b){a=$(b).attr("system-tip-lang");"["==a.substr(0,1)?$(b).attr("title",eval("system.lang"+a)):$(b).attr("title",eval("system.lang."+a))})},initdata:function(){$(document).attr("title",this.lang.system.title+" "+this.version);var a=[],b="\x3cspan\x3e"+
this.lang.title.left+"\x3c/span\x3e";a.push("\x3cspan class\x3d'tree-title-toolbar'\x3e");for(var c in this.lang.tree.toolbar.nav)a.push('\x3ca href\x3d"javascript:void(0);" id\x3d"tree-toolbar-nav-'+c+'" class\x3d"easyui-linkbutton" data-options\x3d"plain:true,iconCls:\'icon-disabled\'" onclick\x3d"javascript:system.navToolbarClick(this);"\x3e'+this.lang.tree.toolbar.nav[c]+"\x3c/a\x3e");a.push("\x3c/span\x3e");if(1<a.length)for(c in b+=a.join(""),this.panel.left_layout.panel("setTitle",b),this.lang.tree.toolbar.nav)switch($("#tree-toolbar-nav-"+
c).linkbutton(),c){case "folders":system.config.foldersShow?$("tree-toolbar-nav-"+c).linkbutton({iconCls:"icon-enabled"}).data("status",1):$("tree-toolbar-nav-"+c).linkbutton({iconCls:"icon-disabled"}).data("status",0)}else this.panel.left_layout.panel("setTitle",b);b="\x3cspan\x3e"+this.lang.title.list+"\x3c/span\x3e";a.length=0;if(1<a.length)for(c in b+=a.join(""),this.panel.body.panel("setTitle",b),this.lang["torrent-head"].buttons)switch($("#torrent-head-buttons-"+c).linkbutton(),c){case "autoExpandAttribute":system.config.autoExpandAttribute?
...
($(this).data("isload",!0),0!=system.currentTorrentId&&setTimeout(function(){system.getTorrentInfos(system.currentTorrentId)},500))}});$.each(this.languages,function(a,b){$("\x3coption/\x3e").text(b).val(a).attr("selected",a==system.lang.name?!0:!1).appendTo(system.panel.top.find("#lang"))});this.panel.top.find("#lang").change(function(){location.href="?lang\x3d"+this.value});this.panel.toolbar.attr("class","panel-header");this.initTree();this.initToolbar();this.initStatusBar();this.initTorrentTable();
...
break;case "torrent-head-buttons-autoExpandAttribute":d={target:null},this.config.autoExpandAttribute=1==c?!1:!0}d&&(1==c?($(a).linkbutton({iconCls:"icon-disabled"}),$(d.target).parent().hide(),c=0):($(a).linkbutton({iconCls:"icon-enabled"}),$(d.target).parent().show(),c=1),$(a).data("status",c),this.saveConfig())},checkDropFiles:function(a){if(a&&a.length){for(var b=[],c=0;c<a.length;c++){var d=a[c];"torrent"==d.name.split(".").pop().toLowerCase()&&b.push(d)}0<b.length&&system.openDialogFromTemplate({id:"dialog-torrent-addfile",
...
text:this.lang.tree.statistics.uploadedBytes,iconCls:"iconfont tr-icon-empty"},{id:"current-downloadedBytes",text:this.lang.tree.statistics.downloadedBytes,iconCls:"iconfont tr-icon-empty"},{id:"current-filesAdded",text:this.lang.tree.statistics.filesAdded,iconCls:"iconfont tr-icon-empty"},{id:"current-sessionCount",text:this.lang.tree.statistics.sessionCount,iconCls:"iconfont tr-icon-empty"},{id:"current-secondsActive",text:this.lang.tree.statistics.secondsActive,iconCls:"iconfont tr-icon-empty"}]}]}],
onSelect:function(a){system.loadTorrentToList({node:a})},lines:!0});for(var a in this.lang.tree.toolbar.nav){var b=this.panel.left.tree("find",a);switch(a){case "folders":system.config.foldersShow?($("#tree-toolbar-nav-"+a).click(),$(b.target).parent().show()):$(b.target).parent().hide()}}},initUIStatus:function(){var a=this.config.ui.status.tree,b;for(b in a){var c=this.panel.left.tree("find",b);c&&c.target&&("open"==a[b]?this.panel.left.tree("expand",c.target):this.panel.left.tree("collapse",c.target))}this.panel.left.show();
this.config.defaultSelectNode&&(c=this.panel.left.tree("find",this.config.defaultSelectNode))&&this.panel.left.tree("select",c.target);a=this.config.ui.status.layout.body;for(b in a)"open"==a[b]?this.panel.layout_body.layout("expand",b):this.panel.layout_body.layout("collapse",b);a=this.config.ui.status.layout.left;for(b in a)"open"==a[b]?this.panel.layout_left.layout("expand",b):this.panel.layout_left.layout("collapse",b);a=this.config.ui.status.layout.main;for(b in a)"open"==a[b]?this.panel.main.layout("expand",
b):this.panel.main.layout("collapse",b)},initTorrentTable:function(){function a(){b&&$(b).remove();b=$("\x3cdiv/\x3e").appendTo("body");b.menu({onClick:function(a){"icon-ok"==a.iconCls?(system.control.torrentlist.datagrid("hideColumn",a.name),b.menu("setIcon",{target:a.target,iconCls:"icon-empty"})):(system.control.torrentlist.datagrid("showColumn",a.name),b.menu("setIcon",{target:a.target,iconCls:"icon-ok"}));system.resetTorrentListFieldsUserConfig(system.control.torrentlist.datagrid("options").columns[0]);
system.saveUserConfig()}});for(var a=system.control.torrentlist.datagrid("getColumnFields"),c=0;c<a.length;c++){var f=a[c],g=system.control.torrentlist.datagrid("getColumnOption",f);0!=g.allowCustom&&"false"!=g.allowCustom&&b.menu("appendItem",{text:g.title,name:f,iconCls:g.hidden?"icon-empty":"icon-ok"})}}this.control.torrentlist=$("\x3ctable/\x3e").attr("class","torrent-list").appendTo(this.panel.list);var b=null,c=-1;$.get(system.rootPath+"template/torrent-fields.json?time\x3d"+new Date,function(d){d=
d.fields;var e=JSON.parse(JSON.stringify(d));0!=system.userConfig.torrentList.fields.length&&(system.userConfig.torrentList.fields.formatter=d.formatter,d=$.extend(d,system.userConfig.torrentList.fields));system.userConfig.torrentList.fields=d;for(var f in d){var g=d[f];e[f]&&e[f].formatter&&(g.formatter=e[f].formatter);g.title=system.lang.torrent.fields[g.field]||g.field;system.setFieldFormat(g)}system.control.torrentlist.datagrid({autoRowHeight:!1,pagination:system.config.pagination,rownumbers:!0,
remoteSort:!1,checkOnSelect:!1,pageSize:system.config.pageSize,pageList:system.config.pageList,idField:"id",fit:!0,striped:!0,sortName:system.userConfig.torrentList.sortName,sortOrder:system.userConfig.torrentList.sortOrder,drophead:!0,columns:[d],onCheck:function(a,b){system.checkTorrentRow(a,b)},onUncheck:function(a,b){system.checkTorrentRow(a,b)},onCheckAll:function(a){system.checkTorrentRow("all",!1)},onUncheckAll:function(a){system.checkTorrentRow("all",!0)},onSelect:function(a,b){-1!=c&&system.control.torrentlist.datagrid("unselectRow",
c);system.getTorrentInfos(b.id);c=a},onUnselect:function(a,b){system.currentTorrentId=0;c=-1},onBeforeLoad:function(a){system.currentTorrentId=0},onSortColumn:function(a,b){var c=system.control.torrentlist.datagrid("getData").originalRows.sort(arrayObjectSort(a,b));system.control.torrentlist.datagrid("loadData",c);system.resetTorrentListFieldsUserConfig(system.control.torrentlist.datagrid("options").columns[0]);system.userConfig.torrentList.sortName=a;system.userConfig.torrentList.sortOrder=b;system.saveUserConfig()},
onRowContextMenu:function(a,b,c){0==system.checkedRows.length&&system.control.torrentlist.datagrid("checkRow",b);a.preventDefault();system.showContextMenu("torrent-list",a)},onHeadDrop:function(a,b){system.resetTorrentListFieldsUserConfig(system.control.torrentlist.datagrid("options").columns[0]);system.saveUserConfig()},onResizeColumn:function(a,b){system.resetTorrentListFieldsUserConfig(system.control.torrentlist.datagrid("options").columns[0]);system.saveUserConfig()},onHeaderContextMenu:function(c,
d){c.preventDefault();b||a();b.menu("show",{left:c.pageX,top:c.pageY})}})},"json")},resetTorrentListFieldsUserConfig:function(a){var b={};$.each(this.userConfig.torrentList.fields,function(a,d){b[d.field]=d});this.userConfig.torrentList.fields=[];$.each(a,function(a,d){a=$.extend({},b[d.field]);a.width=d.width;a.hidden=d.hidden;system.userConfig.torrentList.fields.push(a)})},showContextMenu:function(a,b){var c=this.contextMenus[a];c?c.empty():(c=$("\x3cdiv/\x3e").attr("class","easyui-menu").css({"min-width":"180px"}).appendTo(this.panel.main),
this.contextMenus[a]=c,c.menu());var d=null;switch(a){case "torrent-list":d="start pause - rename remove recheck - morepeers changeDownloadDir copyPath - menu-queue-move-top menu-queue-move-up menu-queue-move-down menu-queue-move-bottom".split(" ");a=this.panel.toolbar;for(var e in d){var f=d[e];if("-"==f)$("\x3cdiv class\x3d'menu-sep'\x3e\x3c/div\x3e").appendTo(c);else{var g=a.find("#toolbar_"+f);0<g.length?c.menu("appendItem",{text:g.attr("title"),id:f,iconCls:g.linkbutton("options").iconCls,disabled:g.linkbutton("options").disabled,
...
$("#status_alt_speed").hide());system.downloadDir=b["download-dir"];0==transmission.downloadDirs.length&&transmission.downloadDirs.push(system.downloadDir);15<=parseInt(system.serverConfig["rpc-version"])?transmission.getFreeSpace(system.downloadDir,function(a){system.serverConfig["download-dir-free-space"]=a.arguments["size-bytes"];system.showFreeSpace(a.arguments["size-bytes"])}):system.showFreeSpace(system.serverConfig["download-dir-free-space"]);a&&system.showStatus(system.lang.system.status.connected)})},
showFreeSpace:function(a){a=-1==a?system.lang["public"]["text-unknown"]:formatSize(a);$("#status_freespace").text(system.lang.dialog["system-config"]["download-dir-free-space"]+" "+a)},reloadTorrentBaseInfos:function(a,b){if(!this.reloading){clearTimeout(this.autoReloadTimer);this.reloading=!0;var c={trackers:transmission.trackers,folders:transmission.torrents.folders};transmission.torrents.getallids(function(a){var b=[],d;for(d in a)b.push(a[d].id);a=transmission.torrents.getErrorIds(b,!0);0<a.length?
transmission.torrents.getallids(function(){system.resetTorrentInfos(c)},a):system.resetTorrentInfos(c)},a,b)}},resetTorrentInfos:function(a){var b=this.currentTorrentId,c=this.panel.left.tree("find","servers");if(c){var d=c.state;this.removeTreeNode("servers-loading")}else this.appendTreeNode(null,[{id:"servers",text:this.lang.tree.servers,state:"closed",iconCls:"iconfont tr-icon-servers"}]),c=this.panel.left.tree("find","servers");var e=this.panel.left.tree("find","btservers"),f=e?e.state:"close",
g;for(g in transmission.trackers){var h=transmission.trackers[g];if(h.isBT){if(!system.config.showBTServers)continue;e||(this.appendTreeNode(c,[{id:"btservers",text:"BT",state:"open",iconCls:"iconfont tr-icon-bt"}]),e=this.panel.left.tree("find","btservers"))}var k=system.panel.left.tree("find",h.nodeid),l=h.name+this.showNodeMoreInfos(h.count,h.size);k?system.updateTreeNodeText(h.nodeid,l,h.connected?"iconfont tr-icon-server":"iconfont tr-icon-server-error"):system.appendTreeNode(h.isBT?e:c,[{id:h.nodeid,
text:l,iconCls:h.connected?"iconfont tr-icon-server":"iconfont tr-icon-server-error"}]);a.trackers[h.nodeid]=null}"closed"==d&&this.panel.left.tree("collapse",c.target);system.config.showBTServers&&e&&"closed"==f&&this.panel.left.tree("collapse",e.target);for(g in a.trackers)(h=a.trackers[g])&&system.removeTreeNode(h.nodeid);transmission.torrents.status[transmission._status.stopped]?system.updateTreeNodeText("paused",system.lang.tree.paused+this.showNodeMoreInfos(transmission.torrents.status[transmission._status.stopped].length)):
system.updateTreeNodeText("paused",system.lang.tree.paused);transmission.torrents.status[transmission._status.seed]?system.updateTreeNodeText("sending",system.lang.tree.sending+this.showNodeMoreInfos(transmission.torrents.status[transmission._status.seed].length)):system.updateTreeNodeText("sending",system.lang.tree.sending);transmission.torrents.status[transmission._status.seedwait]?(k=system.panel.left.tree("find","sending"),c=system.panel.left.tree("getChildren",k.target),l=system.lang.tree.wait+
this.showNodeMoreInfos(transmission.torrents.status[transmission._status.seedwait].length),0<c.length?system.updateTreeNodeText(c[0].id,l):system.appendTreeNode(k,[{id:"seedwait",text:l,iconCls:"iconfont tr-icon-wait"}])):system.removeTreeNode("seedwait");transmission.torrents.status[transmission._status.check]?system.updateTreeNodeText("check",system.lang.tree.check+this.showNodeMoreInfos(transmission.torrents.status[transmission._status.check].length)):system.updateTreeNodeText("check",system.lang.tree.check);
transmission.torrents.status[transmission._status.checkwait]?(k=system.panel.left.tree("find","check"),c=system.panel.left.tree("getChildren",k.target),l=system.lang.tree.wait+this.showNodeMoreInfos(transmission.torrents.status[transmission._status.checkwait].length),0<c.length?system.updateTreeNodeText(c[0].id,l):system.appendTreeNode(k,[{id:"checkwait",text:l,iconCls:"iconfont tr-icon-wait"}])):system.removeTreeNode("checkwait");transmission.torrents.status[transmission._status.download]?system.updateTreeNodeText("downloading",
...
break;case "downloading":b=transmission.torrents.status[transmission._status.download];break;case "downloadwait":b=transmission.torrents.status[transmission._status.downloadwait];break;case "actively":b=transmission.torrents.actively;break;case "error":b=transmission.torrents.error;break;case "warning":b=transmission.torrents.warning;break;case "search-result":b=transmission.torrents.searchResult;break;case "btservers":b=transmission.torrents.btItems;break;default:-1!=a.node.id.indexOf("folders-")&&
(c=transmission.torrents.folders[a.node.id])&&(b=c.torrents)}}this.config.defaultSelectNode!=a.node.id&&(this.control.torrentlist.datagrid("loadData",[]),this.config.defaultSelectNode=a.node.id,this.saveConfig());a=[];for(var e in b){if(!b[e])return;c=this.lang.torrent["status-text"][b[e].status];parseFloat(100*b[e].percentDone).toFixed(2);c==transmission._status.check&&parseFloat(100*b[e].recheckProgress).toFixed(2);0!=b[e].error?c="\x3cspan class\x3d'text-status-error'\x3e"+c+"\x3c/span\x3e":b[e].warning&&
(c="\x3cspan class\x3d'text-status-warning' title\x3d'"+b[e].warning+"'\x3e"+c+"\x3c/span\x3e");d={};d=$.extend(d,b[e]);d.status=c;d.statusCode=b[e].status;d.completeSize=Math.max(0,b[e].totalSize-b[e].leftUntilDone);d.leecherCount=b[e].leecher;d.seederCount=b[e].seeder;a.push(d)}this.updateTorrentCurrentPageDatas(a)}},updateTorrentCurrentPageDatas:function(a){var b=this.control.torrentlist.datagrid("getRows");if(0==a.length&&0<b.length)this.control.torrentlist.datagrid("loadData",[]);else{var c=
this.control.torrentlist.datagrid("options"),d=null;c.sortName&&(d=c.sortName,a=a.sort(arrayObjectSort(d,c.sortOrder)));if(0==b.length||a.length!=this.control.torrentlist.datagrid("getData").total&&a.length>c.pageSize)this.control.torrentlist.datagrid({loadFilter:pagerFilter,pageNumber:c.pageNumber,sortName:d,sortOrder:c.sortOrder}).datagrid("loadData",a);else{this.control.torrentlist.datagrid("getData").originalRows=a;d=(c.pageNumber-1)*parseInt(c.pageSize);c=d+parseInt(c.pageSize);a=a.slice(d,c);
c={};d={};for(var e in transmission.torrents.recently){var f=transmission.torrents.recently[e];c[f.id]=!0}for(e in a)f=a[e],d[f.id]=f;var g={};for(e=b.length-1;0<=e;e--){f=b[e];var h=d[f.id];h?c[f.id]?(this.control.torrentlist.datagrid("updateRow",{index:e,row:h}),g[f.id]=f):transmission.torrents.removed?0<transmission.torrents.removed.length&&-1!=$.inArray(f.id,transmission.torrents.removed)?this.control.torrentlist.datagrid("deleteRow",e):g[f.id]=f:g[f.id]=f:this.control.torrentlist.datagrid("deleteRow",
e)}for(e in a)f=a[e],g[f.id]||this.control.torrentlist.datagrid("appendRow",f)}}},getTorrentNameBar:function(a){var b="",c=a.name;switch(a.status){case transmission._status.stopped:b="iconlabel icon-pause-small";break;case transmission._status.check:b="iconlabel icon-checking";break;case transmission._status.download:b="iconlabel icon-down";break;case transmission._status.seed:b="iconlabel icon-up";break;case transmission._status.seedwait:case transmission._status.downloadwait:case transmission._status.checkwait:b=
"iconlabel icon-wait"}c+="\n"+a.downloadDir;a.warning&&(b="iconlabel icon-warning-type1",c+="\n\n"+this.lang["public"]["text-info"]+": "+a.warning);0!=a.error&&(b="iconlabel icon-exclamation",c+="\n\n"+this.lang["public"]["text-info"]+": "+a.errorString);return'\x3cspan class\x3d"'+b+'" title\x3d"'+c+'"\x3e'+a.name+"\x3c/span\x3e"},getTorrentProgressBar:function(a,b){a+="%";var c="";switch("object"==typeof b?b.status:b){case transmission._status.stopped:c="torrent-progress-stop";break;case transmission._status.checkwait:case transmission._status.check:c=
"torrent-progress-check";break;case transmission._status.downloadwait:case transmission._status.download:c="torrent-progress-download";break;case transmission._status.seedwait:case transmission._status.seed:c="torrent-progress-seed"}"object"==typeof b&&(b.warning&&(c="torrent-progress-warning"),0!=b.error&&(c="torrent-progress-error"));return'\x3cdiv class\x3d"torrent-progress" title\x3d"'+a+'"\x3e\x3cdiv class\x3d"torrent-progress-text"\x3e'+a+'\x3c/div\x3e\x3cdiv class\x3d"torrent-progress-bar '+
c+'" style\x3d"width:'+a+';"\x3e\x3c/div\x3e\x3c/div\x3e'},addTorrentsToServer:function(a,b,c,d){var e=b-a.length,f=a.shift();f?(this.showStatus(this.lang.system.status.queue+(e+1)+"/"+b+"\x3cbr/\x3e"+f,0),transmission.addTorrentFromUrl(f,d,c,function(e){system.addTorrentsToServer(a,b,c,d)})):(this.showStatus(this.lang.system.status.queuefinish),this.getServerStatus())},changeSelectedTorrentStatus:function(a,b,c){var d=this.control.torrentlist.datagrid("getChecked"),e=[];a||(a="start");for(var f in d)e.push(d[f].id);
c||(c="torrent-"+a);if(0<e.length){if(b){var g=b.linkbutton("options").iconCls;b.linkbutton({disabled:!0,iconCls:"icon-loading"})}transmission.exec({method:c,arguments:{ids:e}},function(a){b&&b.linkbutton({iconCls:g});system.control.torrentlist.datagrid("uncheckAll");system.reloadTorrentBaseInfos()})}},searchTorrents:function(a){if(""!=a){var b=transmission.torrents.search(a);if(null==b||0==b.length)this.removeTreeNode("search-result");else{var c=this.panel.left.tree("find","search-result");a=this.lang.tree["search-result"]+
" : "+a+" ("+b.length+")";null==c?(this.appendTreeNode("torrent-all",[{id:"search-result",text:a,iconCls:"iconfont tr-icon-search"}]),c=this.panel.left.tree("find","search-result")):this.panel.left.tree("update",{target:c.target,text:a});this.panel.left.tree("select",c.target)}}},getTorrentInfos:function(a){if(transmission.torrents.all[a]&&!(transmission.torrents.all[a].infoIsLoading||0<this.currentTorrentId&&transmission.torrents.all[this.currentTorrentId]&&transmission.torrents.all[this.currentTorrentId].infoIsLoading)&&
(this.currentTorrentId=a,!this.panel.attribute.panel("options").collapsed)){var b=transmission.torrents.all[a];b.infoIsLoading=!0;var c="fileStats,trackerStats,peers,leftUntilDone,status,rateDownload,rateUpload,uploadedEver,uploadRatio,error,errorString";b.moreInfosTag||(c+=",files,trackers,comment,dateCreated,creator,downloadDir");transmission.torrents.getMoreInfos(c,a,function(c){b.infoIsLoading=!1;null!=c&&(jQuery.extend(b,c[0]),0==system.currentTorrentId||system.currentTorrentId!=a?system.clearTorrentAttribute():
...
[]);system.panel.attribute.find("span[id*\x3d'torrent-attribute-value']").html("")},updateCurrentPageDatas:function(a,b,c){var d=c.datagrid("getRows"),e=c.datagrid("options"),f=null;e.sortName&&(f=e.sortName,b=b.sort(arrayObjectSort(f,e.sortOrder)));if(0==d.length||b.length!=c.datagrid("getData").total&&b.length>e.pageSize)c.datagrid({loadFilter:pagerFilter,pageNumber:1,sortName:f,sortOrder:e.sortOrder}).datagrid("loadData",b);else{c.datagrid("getData").originalRows=b;f=(e.pageNumber-1)*parseInt(e.pageSize);
e=f+parseInt(e.pageSize);b=b.slice(f,e);e={};for(var g in b)f=b[g],e[f[a]]=f;for(g=d.length-1;0<=g;g--)f=d[g],(b=e[f[a]])?c.datagrid("updateRow",{index:g,row:b}):c.datagrid("deleteRow",g)}},fillTorrentBaseInfos:function(a){$.each(a,function(a,c){switch(a){case "rateDownload":case "rateUpload":c=formatSize(c,!0,"speed");break;case "totalSize":case "uploadedEver":case "leftUntilDone":case "completeSize":c=formatSize(c);break;case "addedDate":case "dateCreated":case "doneDate":c=formatLongTime(c);break;
case "status":c=system.lang.torrent["status-text"][c];break;case "error":0==c?system.panel.attribute.find("#torrent-attribute-tr-error").hide():system.panel.attribute.find("#torrent-attribute-tr-error").show();break;case "remainingTime":c=31536E8<=c?"\u221e":getTotalTime(c);break;case "comment":c=system.replaceURI(c)}system.panel.attribute.find("#torrent-attribute-value-"+a).html(c)})},fillTorrentFileList:function(a){var b=a.files,c=a.fileStats,d=[],e=a.name.length+1,f;for(f in b){var g=b[f],h=c[f],
k=parseFloat(h.bytesCompleted/g.length*100).toFixed(2);d.push({name:g.name==a.name?g.name:g.name.substr(e),index:f,bytesCompleted:h.bytesCompleted,percentDone:system.getTorrentProgressBar(k,transmission._status.download),length:g.length,wanted:system.lang.torrent.attribute.status[h.wanted],priority:'\x3cspan class\x3d"iconlabel icon-flag-'+h.priority+'"\x3e'+system.lang.torrent.attribute.priority[h.priority]+"\x3c/span\x3e"})}this.updateCurrentPageDatas("index",d,system.panel.attribute.find("#torrent-files-table"))},
...
function(a,c,d){return system.getTorrentNameBar(transmission.torrents.all[c.id])}}break;case "ratio":a.formatter=function(a,c,d){c="";1>parseFloat(a)&&(c="text-status-warning");return'\x3cspan class\x3d"'+c+'"\x3e'+a+"\x3c/span\x3e"};break;case "remainingTime":a.formatter=function(a,c,d){return 31536E8<=a?"\u221e":getTotalTime(a)}}},reloadData:function(){this.reloadSession();this.reloading=!1;this.getServerStatus();this.reloading=!1;this.reloadTorrentBaseInfos()},loadFolderList:function(a){this.removeTreeNode("folders-loading");
for(var b in a){var c=a[b];c&&system.removeTreeNode(c.nodeid)}0!=transmission.downloadDirs.length&&timedChunk(transmission.downloadDirs,this.appendFolder,this,10,function(){0<navigator.userAgent.indexOf("Firefox")&&system.panel.left.find("span.nav-total-size").css({"margin-top":"-19px"})})},appendFolder:function(a){if(a){var b="folders";a=a.split("/");var c="folders-",d;for(d in a){var e=a[d];if(""!=e){c+=this.B64.encode(e);var f=this.panel.left.tree("find",c),g=transmission.torrents.folders[c];e+=
this.showNodeMoreInfos(g.count,g.size);f?this.updateTreeNodeText(c,e):(this.appendTreeNode(b,[{id:c,text:e,iconCls:"iconfont tr-icon-file"}]),"folders"!=b&&(f=this.panel.left.tree("find",b),this.panel.left.tree("collapse",f.target)));b=c}}}},replaceURI:function(a){return a.replace(/(http|https|ftp):\/\/([^/:]+)(:\d*)?([^# ]*)/ig,function(a){return'\x3ca href\x3d"'+a+'" target\x3d"_blank"\x3e'+a+"\x3c/a\x3e"})},readConfig:function(){this.readUserConfig();var a=this.getStorageData(this.configHead+".system");
a&&(this.config=$.extend(!0,this.config,JSON.parse(a)));for(var b in this.storageKeys.dictionary)this.dictionary[b]=this.getStorageData(this.storageKeys.dictionary[b])},saveConfig:function(){this.setStorageData(this.configHead+".system",JSON.stringify(this.config));for(var a in this.storageKeys.dictionary)this.setStorageData(this.storageKeys.dictionary[a],this.dictionary[a]);this.saveUserConfig()},readUserConfig:function(){var a=window.localStorage[this.configHead];a&&(a=JSON.parse(a),this.userConfig=
$.extend(!0,this.userConfig,a))},saveUserConfig:function(){window.localStorage[this.configHead]=JSON.stringify(this.userConfig)},uploadTorrentFile:function(a,b,c,d){if(window.FileReader){var e=$("input[id\x3d'"+a+"']")[0].files;$.each(e,function(a,g){transmission.addTorrentFromFile(g,b,c,d,e.length)})}else alert(system.lang.publit["text-browsers-not-support-features"])},checkUpdate:function(){$.ajax({url:this.checkUpdateScript,dataType:"json",success:function(a){a&&a.update&&(system.codeupdate<a.update?
($("#area-update-infos").show(),$("#msg-updateInfos").html(a.update+" -\x3e "+a.infos)):$("#area-update-infos").hide())}})},changeLanguages:function(a){a!=this.lang.name&&a&&(this.config.defaultLang=a,this.saveConfig(),location.href="?lang\x3d"+a)},getStorageData:function(a,b){return null==window.localStorage[a]?b:window.localStorage[a]},setStorageData:function(a,b){window.localStorage[a]=b},openDialogFromTemplate:function(a){a=$.extend(!0,{id:null,options:null,datas:null},a);if(null!=a.id){var b=
a.id,c=a.options,d=a.datas,e=$("#"+b);e.length?(e.dialog("open"),d&&$.each(d,function(a,b){e.data(a,b)}),e.dialog({content:system.templates[b]})):(c=$.extend(!0,{title:"",width:100,height:100,resizable:!1,cache:!0,content:"loading...",modal:!0},c),$("\x3cdiv/\x3e").attr("id",b).appendTo(document.body).dialog(c),$.get(system.rootPath+"template/"+b+".html?time\x3d"+new Date,function(a){system.templates[b]=a;d&&$.each(d,function(a,c){$("#"+b).data(a,c)});$("#"+b).dialog({content:a})}))}},debug:function(a,
b){window.console&&window.console.log&&window.console.log(a,b)},initThemes:function(){this.themes&&$("#select-themes").combobox({groupField:"group",data:this.themes,editable:!1,panelHeight:"auto",onChange:function(a){var b=(a+";").split(";"),c=b[0];b=b[1]||"logo.png";$("#styleEasyui").attr("href","tr-web-control/script/easyui/themes/"+c+"/easyui.css");$("#logo").attr("src","tr-web-control/"+b);system.config.theme=a;system.saveConfig()},onLoadSuccess:function(){$(this).combobox("setValue",system.config.theme||
"default")}})}};$(document).ready(function(){$.getScript(system.rootPath+"lang/default.js");$.getScript(system.rootPath+"lang/_languages.js",function(){system.init(location.search.getQueryString("lang"),location.search.getQueryString("local"))})});
function pagerFilter(a){"number"==typeof a.length&&"function"==typeof a.splice&&(a={total:a.length,rows:a});var b=$(this),c=b.datagrid("options"),d=b.datagrid("getPager"),e=b.data("buttons");d.pagination({onSelectPage:function(e,f){c.pageNumber=e;c.pageSize=f;d.pagination("refresh",{pageNumber:e,pageSize:f});b.datagrid("loadData",a)},buttons:e});a.originalRows||(a.originalRows=a.rows);e=(c.pageNumber-1)*parseInt(c.pageSize);var f=e+parseInt(c.pageSize);a.rows=a.originalRows.slice(e,f);return a};
