...
var c={}
c=$.extend(c,s[i]),c.status=l,c.statusCode=s[i].status,c.completeSize=s[i].totalSize-s[i].leftUntilDone,c.leecherCount=s[i].leecher,c.seederCount=s[i].seeder,o.push(c)}this.updateTorrentCurrentPageDatas(o)}}},updateTorrentCurrentPageDatas:function(t){var e=this.control.torrentlist.datagrid("getRows")
